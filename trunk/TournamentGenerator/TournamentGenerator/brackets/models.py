...
class Contestant(models.Model):
    player_1 = models.ForeignKey(User, help_text="Player 1", null=False, blank=False,
                                 unique=False, related_name="player_1", on_delete=models.CASCADE)
    player_2 = models.ForeignKey(User, help_text="Player 2", null=True, blank=True,
                                 unique=False, related_name="player_2", on_delete=models.CASCADE)
    player_3 = models.ForeignKey(User, help_text="Player 3", null=True, blank=True,
                                 unique=False, related_name="player_3", on_delete=models.CASCADE)
    player_4 = models.ForeignKey(User, help_text="Player 4", null=True, blank=True,
                                 unique=False, related_name="player_4", on_delete=models.CASCADE)
    fifa_team = models.ForeignKey('FIFATeam', on_delete=models.CASCADE)
...
class Match(models.Model):
    ...
    contestant_1 = models.ForeignKey('Contestant', on_delete=models.CASCADE, null=True, unique=False,
                                     help_text="Contestant 1", related_name="contestant_1")
    contestant_2 = models.ForeignKey('Contestant', on_delete=models.CASCADE, null=True, unique=False,
    ...
    fixture = models.ForeignKey('Fixture', on_delete=models.CASCADE, help_text="Part of Fixure", null=False, blank=False)
