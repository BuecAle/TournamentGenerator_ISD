...
class Team(models.Model):
    ...
    Manager = models.CharField(max_length=120, default="", validators=[validate_name_length])
    Captain = models.CharField(max_length=120, default="", validators=[validate_name_length])
